...
namespace Server.Mobiles
{
	...
	public class PlayerMobile : Mobile, IHonorTarget
	{
		...
		*/
        ...
        #region Staff Titles
        private int m_StaffItemHue;
        private int m_StaffNameHue = 1150;
        private int m_StaffTitleHue = 0x38;
        private string m_StaffTitle;
        private StaffTitles m_StaffTitles;

        [CommandProperty( AccessLevel.Owner )]
        public StaffTitles StaffTitles
        {
            get { return m_StaffTitles; }
            set
            {
                if( ( value >= StaffTitles.None ) && ( value <= StaffTitles.PvPCoordinator ) )
                {
                    m_StaffTitles = value;
                    SetStaffInfo();
        ...
        public int StaffItemHue
        {
            get { return m_StaffItemHue; }
            set { m_StaffItemHue = value; }
        }

        public void SetStaffInfo()
        {
            switch( m_StaffTitles )
            {
                case StaffTitles.None: m_StaffTitle = ""; m_StaffItemHue = 0; NameHue = 0; break;
                case StaffTitles.ShardOwner: m_StaffTitle = "Shard Owner"; m_StaffItemHue = 0x7E3; NameHue = m_StaffNameHue; break;
                case StaffTitles.Admin: m_StaffTitle = "Admin"; m_StaffItemHue = 0x2C1; NameHue = m_StaffNameHue; break;
                case StaffTitles.LeadDeveloper: m_StaffTitle = "Lead Developer"; m_StaffItemHue = 0x5A5; NameHue = m_StaffNameHue; break;
                case StaffTitles.Developer: m_StaffTitle = "Developer"; m_StaffItemHue = 0x1; NameHue = m_StaffNameHue; break;
                case StaffTitles.Seer: m_StaffTitle = "Seer"; m_StaffItemHue = 0x57A; NameHue = m_StaffNameHue; break;
                case StaffTitles.LeadGM: m_StaffTitle = "Lead GM"; m_StaffItemHue = 0x4AA; NameHue = m_StaffNameHue; break;
                case StaffTitles.LeadSeer: m_StaffTitle = "Lead Seer"; m_StaffItemHue = 0x581; NameHue = m_StaffNameHue; break;
                case StaffTitles.GameMaster: m_StaffTitle = "Game Master"; m_StaffItemHue = 0x25; NameHue = m_StaffNameHue; break;
                case StaffTitles.Webmaster: m_StaffTitle = "Webmaster"; m_StaffItemHue = 0x54E; NameHue = m_StaffNameHue; break;
                case StaffTitles.LeadCounselor: m_StaffTitle = "Lead Counselor"; m_StaffItemHue = 0x484; NameHue = m_StaffNameHue; break;
                case StaffTitles.Counselor: m_StaffTitle = "Counselor"; m_StaffItemHue = 0x2; NameHue = m_StaffNameHue; break;
                case StaffTitles.RPCoordinator: m_StaffTitle = "RP Coordinator"; m_StaffItemHue = 0x501; NameHue = m_StaffNameHue; break;
                case StaffTitles.PvPCoordinator: m_StaffTitle = "PvP Coordinator"; m_StaffItemHue = 0x485; NameHue = m_StaffNameHue; break;
                case StaffTitles.WorldBuilder: m_StaffTitle = "World Builder"; m_StaffItemHue = 0x8A5; NameHue = m_StaffNameHue; break;
            }
        }
        #endregion
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
                case 29:
                {
                    m_StaffItemHue = reader.ReadInt();
                    m_StaffTitle = reader.ReadString();
                    m_StaffTitles = (StaffTitles)reader.ReadInt();
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            //Version 29
            writer.Write( (int)m_StaffItemHue );
            writer.Write( (string)m_StaffTitle );
            writer.Write( (int)m_StaffTitles );

            //Version 28 - End RunUO 
		...
		{
            if( AccessLevel != AccessLevel.Player && !String.IsNullOrEmpty( StaffTitle ) )
            {
                PrivateOverheadMessage( MessageType.Label, 0x38, true, String.Format( "({0})", StaffTitle ), from.NetState );
            }
